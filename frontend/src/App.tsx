...
function App() {
    ...
    return (
        <div id="App" className="container flex flex-col">
            <div id="top-header" className="h-24 py-3">
                v2
            </div>
            <div>
                <Card>
                        ...
                        <div className="w-full">
                            <div className="flex justify-between pb-3">
                                <div className="flex items-center">
                                    <span className="pr-5 text-center">서버 개수 : {files.length}</span>
                                </div>
                                <Button>추가</Button>
                            </div>
                            <ContextMenu>
                                                                ...
                                                                <div>
                                                                    <button
                                                                        className={`w-10 h-10 flex items-center justify-center rounded-full p-1 transition-colors duration-150 ease-in-out ${
                                                                            checkState
                                                                                ? 'bg-checkbox-checked text-checkbox-checked-text'
                                                                                : 'bg-checkbox-unchecked text-checkbox-unchecked-text'
                                                                        }`}
                                                                        onClick={() => {
